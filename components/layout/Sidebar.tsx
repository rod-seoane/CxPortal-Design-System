...
// ── Nav structure — top-level order is curated for usability, not alphabetical.
// Each group's own items are alphabetical by label (Components explicitly so;
// others reflect their module's natural task order, e.g. Open Inventory's
// Dashboard first). ──────────────────────────────────────────────────────────
